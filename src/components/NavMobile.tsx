...
export const NavMobile: React.FC = () => {
  ...
  return (
    <div className='relative justify-between min-h-[100px] h-[100px] flex xl:hidden items-center text-[16px] font-semibold text-Primary'>
      ...
      {opened && (
        <div className='absolute z-10 top-20 max-w-screen w-full h-screen overflow-hidden bg-Background text-[#FFFFFF] text-3xl'>
          <div className='flex flex-col text[18px] gap-y-1 text-Primary'>
            <div className='w-full p-0 m-0 list-none flex flex-col gap-1'>
              <Link
                href='/projects/personal'
                onClick={toggleMenu}
                className='text-[16px] py-1 font-500 border-b border-[#1F2937] text-White-Custom border-1 mx-4'
              >
                Projects
              </Link>
